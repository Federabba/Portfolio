...
const roles = [
  ...
  { date:'Jul 2021 — Sep 2021', role:'Digital Marketing Intern', co:'The Artisan Food Company', logo:'assets/img/logos/artisan-food-company.png', badge:'A',
...
function workCard(w){
  ...
  const href = w.type === 'pdf' ? `assets/pdf/${w.file}` : `assets/video/${w.file}`;
  el.innerHTML = `
    <div class="work-top">
  ...
  card.innerHTML = `
    ...
    <div class="cs-body"><div class="cs-body-inner">
      ...
      <div class="cs-actions">
        <a href="assets/pdf/case-study-${i+1}.pdf" target="_blank" class="btn btn-outline btn-sm">${icons.pdf} Download PDF</a>
        <a href="assets/video/case-study-${i+1}.mp4" target="_blank" class="btn btn-outline btn-sm">${icons.video} Watch video</a>
      </div>
    </div></div>`;
