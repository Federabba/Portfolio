...
const workItems = [
  ...
  {type:'pdf', file:'county-broadband-rugby-media-schedule.pdf', title:'Media Schedule', desc:'The full channel-by-channel scheduling grid for the campaign — landing pages, email, DM, Meta, social and video, mapped day by day.', tag:'Planning document', company:'County Broadband', campaign:'Rugby World Cup Campaign'},
